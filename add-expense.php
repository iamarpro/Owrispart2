...
if(isset($_POST['submit']))
  {
    ...
    $dateexpense=$_POST['dateexpense'];
	 ...
	 $images=$_POST['image'];
    $query=mysqli_query($con, "insert into tblexpense(UserId,ExpenseDate,ExpenseItem,ExpenseCost,image) value('$userid','$dateexpense','$item','$costitem','$images')");
if($query){
